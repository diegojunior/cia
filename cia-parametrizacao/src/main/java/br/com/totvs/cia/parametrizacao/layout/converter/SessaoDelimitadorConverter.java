...
@Component
public class SessaoDelimitadorConverter extends JsonConverter<Sessao, SessaoJson> {
	...
	public SessaoJson convertFrom(final Sessao model) {
		...
		Collections.sort(sessaoJson.getCampos(), new CamposDelimitadorComparator());
	...
	private static class CamposDelimitadorComparator implements Comparator<CampoJson> {
		@Override
