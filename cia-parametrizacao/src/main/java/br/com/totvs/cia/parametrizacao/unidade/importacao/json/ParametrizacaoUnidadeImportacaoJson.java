...
@NoArgsConstructor
@AllArgsConstructor
public class ParametrizacaoUnidadeImportacaoJson implements Json {
	...
	public ParametrizacaoUnidadeImportacaoJson(final AbstractParametrizacaoUnidadeImportacao model) {
		this.id = model.getId();
