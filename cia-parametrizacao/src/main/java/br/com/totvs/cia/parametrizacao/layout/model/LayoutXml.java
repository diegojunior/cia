...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "PA_LAYOUT_XML")
@EqualsAndHashCode(callSuper = false)
@PrimaryKeyJoinColumn(name = "ID")
public class LayoutXml extends AbstractLayout {
	...
	@JoinTable(name = "PA_LAYOUT_XML_SESSAO", joinColumns = @JoinColumn(name = "ID_LAYOUT_XML"), inverseJoinColumns = @JoinColumn(name = "ID_SESSAO"))
