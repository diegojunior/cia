...
import br.com.totvs.cia.gateway.amplis.processamento.posicao.rendavariavel.avista.service.PosicaoAmplisRendaVariavelAVistaService;
...
@Component
public class PosicaoAmplisRendaVariavelAVistaAdapter {
	
	private static final String FECHAMENTO = "F";

	@Autowired
	private PosicaoAmplisRendaVariavelAVistaService processamentoRendaVariavelAVistaAmplisService;
	...
	public List<UnidadeProcessamentoJson> listBy(final Date dataPosicao) {
		...
		return this.processamentoRendaVariavelAVistaAmplisService.listBy(data);
	}
	
	public List<UnidadeProcessamentoJson> listBy(final Date dataPosicao, final String cliente){
		String data = DateUtil.format(dataPosicao, DateUtil.yyyy_MM_dd);
		
		return this.processamentoRendaVariavelAVistaAmplisService.listBy(cliente, data, FECHAMENTO);
	}
}