...
import br.com.totvs.cia.gateway.amplis.processamento.posicao.fundos.investimento.service.PosicaoAmplisFundoInvestimentoService;
...
@Component
public class PosicaoAmplisFundoInvestimentoAdapter {
	
	@Autowired
	private PosicaoAmplisFundoInvestimentoService posicaoAmplisService;
