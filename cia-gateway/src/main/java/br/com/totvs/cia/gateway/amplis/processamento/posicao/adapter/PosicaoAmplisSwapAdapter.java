...
import br.com.totvs.cia.gateway.amplis.processamento.posicao.swap.service.PosicaoAmplisSwapService;
...
@Component
public class PosicaoAmplisSwapAdapter {
	
	@Autowired
	private PosicaoAmplisSwapService posicaoAmplisService;
