...
export default class Cadastro extends Component {
	...
	finish (step1, step2, step3) {
		var layoutPosicional = {
			id: null, 
			codigo: step3.layout.identificacao.codigo, 
			descricao: step3.layout.identificacao.descricao,
			status: constants.getStatus()[0], 
			sessoes: step2.sessoes};
		return LayoutPosicionalService.incluir(layoutPosicional)
			.then (data => {
				this.props.template.successMessage('Layout Posicional incluído com Sucesso.');
				return data;
			}).catch (error => {
	...
	cancel () {
		this.refs.wizardLayoutPosicional.clear();
	}
    			...
    			<div className="row">
    				<div className="col-lg-12">
    					<div className="page-header">
    						<Link to="/cia/home" className="fa fa-home"></Link> - Parametrização - Layout Posicional - Cadastro
    					</div>
    				</div>
					...
					<div className="col-lg-12">
						...
						<Wizard id="wizardLayoutPosicional"
							ref="wizardLayoutPosicional"
							next={this.next}
							finish={this.finish}
							cancel={this.cancel}>
							...
							<Sessao label="Sessões do Layout Posicional"
