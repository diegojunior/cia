	...
	generateRows () {
		...
		var sessoes = this.state.layout.sessoes.map((sessao, index) => {
			...
			return (<div className="panel panel-default" key={index}>
						<div className="panel-heading">
							<a data-toggle="collapse" data-parent="#accordionPosicionalDetalhe" href={"#accordionPosicionalDetalhe"+index} aria-expanded="true" className="collapsed">
								{sessao.nome + ' - ' + sessao.codigo}
							</a>								
						</div>
						<div id={"accordionPosicionalDetalhe"+index} className="panel-collapse collapse in" aria-expanded="true">
		...
		return (<div className="row">
					<div className="col-lg-12">
						<div className="panel-group" id="accordionPosicionalDetalhe">
							{sessoes}
						</div>
					</div>
				</div>);
				...
				<div className="row">
					<div className="col-lg-12">
						<div className="page-header">
							<Link to="/cia/home" className="fa fa-home"></Link> - Parametrização - Layout Posicional - Detalhe
						</div>
					</div>
