...
export default class Pesquisa extends Component {
	...
	consultar () {
		return (event) => {
			...
			this.props.template.consultar(this.state.codigoFilter, this.state.descricaoFilter, statusConstant);
		}
	}
	...
	clear () {
		this.refs.formValidator.clearValues();
		this.refs.statusFilter.setDefaultValue(constants.getStatus()[0].codigo);
		let newState = update(this.state, {codigoFilter: {$set: ''}, descricaoFilter: {$set: ''}, statusFilter: {$set: constants.getStatus()[0]}});
				...
				<div className="row">
					<div className="col-lg-12">
						<div className="page-header">
							<Link to="/cia/home" className="fa fa-home"></Link> - Parametrização - Layout XML - Pesquisa
						</div>
					</div>
					<div className="col-lg-12">
