...
export default class Confirmacao extends Component {
	...
	generateRows () {
		...
		var sessoes = this.state.layout.sessoes.map((sessao, index) => {
			...
			return (<div className="panel panel-default" key={index}>
						<div className="panel-heading">
							<a data-toggle="collapse" data-parent="#accordionDelimitadorConfirmacao" href={"#accordionDelimitadorConfirmacao"+index} aria-expanded="true" className="collapsed">
								{sessao.nome + ' - ' + sessao.codigo}
							</a>								
						</div>
						<div id={"accordionDelimitadorConfirmacao"+index} className="panel-collapse collapse in" aria-expanded="true">
		...
		return (<div className="row">
					<div className="col-lg-12">
						<div className="panel-group" id="accordionDelimitadorConfirmacao">
							{sessoes}
						</div>
					</div>
				</div>);
	...
	render(){
		...
		if (identificacao != null) {
			...
			tipoDelimitador = identificacao.tipoDelimitador;
		}
