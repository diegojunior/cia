...
@Component
public class ImportacaoItemBlocoWriter implements ItemWriter<UnidadeImportacaoSegregada> {

	private static final Logger log = Logger.getLogger(ImportacaoItemBlocoWriter.class);
