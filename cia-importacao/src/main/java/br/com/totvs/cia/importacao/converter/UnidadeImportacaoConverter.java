...
@Component
public class UnidadeImportacaoConverter extends JsonObjectConverter<UnidadeLayoutImportacao, UnidadeImportacaoProcessamentoJson> {
	...
	@Override
	public UnidadeImportacaoProcessamentoJson convertFrom(final UnidadeLayoutImportacao model) {
		return null;
	}
	...
	public UnidadeLayoutImportacao convertFrom(final UnidadeImportacaoProcessamentoJson json, final List<Dominio> dominios) {
		...
		unidadeImportacao.setNumeroLinha(json.getNumeroLinha());
		unidadeImportacao.setNumeroLinhaAnterior(json.getNumeroLinhaAnterior());
		for (final CampoImportacaoProcessamentoJson campo : json.getCampos()) {
